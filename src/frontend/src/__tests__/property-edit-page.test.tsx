...
function renderEditPage() {
  return render(
    <MemoryRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }} initialEntries={[`/properties/${property.id}/edit`]}>
      <Routes>
...
test('clicking next on the edit page advances to review without saving the property', async () => {
  ...
  const updateProperty = jest.spyOn(propertyService, 'updateProperty').mockResolvedValue(property)
